...
VALUES (DEFAULT, 3.00, 'Unavailable'),
       (DEFAULT, 3.00, 'Unavailable'),
       (DEFAULT, 3.00, 'Unavailable'),
       (DEFAULT, 3.00, 'Unavailable');
...
VALUES (DEFAULT, 'John', 'Doe', 'Dublin', '0123456789', 'john.doe@example.com', '1980-01-01', 'None', 1),
       (DEFAULT, 'Jane', 'Smith', 'Cork', '1234567890', 'jane.smith@example.com', '1985-01-01', 'None', 2),
       (DEFAULT, 'Alice', 'Johnson', 'Galway', '2345678901', 'alice.johnson@example.com', '1990-01-01', 'None', 3),
       (DEFAULT, 'Bob', 'Williams', 'Limerick', '3456789012', 'bob.williams@example.com', '1995-01-01', 'None', 4);
...
VALUES (3, 3, 150.00, '2023-01-01', 'Paid', 'Yes', 0.00, 3456, 7890);

INSERT INTO CashPayments (memberNum, membershipID, amount, payment_date, status, receipt, discount, currency_type) 
VALUES (4, 4, 250.00, '2023-01-01', 'Paid', 'Yes', 0.00, 'Euro');

INSERT INTO Qualifications (code, title, description, issuing_body, date_issued) 
VALUES (DEFAULT, 'Certified Yoga Instructor', 'Certification for yoga instruction', 'Yoga Ireland', '2023-02-01'),
...
VALUES (DEFAULT, 'John', 'Doe', '1234567A', 'IE00BANK1234567890', 'john.doe@example.com', 'Dublin', '246780987', '2023-01-01', 'Trainer', 1, NULL),
       (DEFAULT, 'Jane', 'Smith', '2345678B', 'IE00BANK2345678901', 'jane.smith@example.com', 'Cork', '378905947', '2023-01-01', 'Trainer', 2, 1),
       (DEFAULT, 'Alice', 'Johnson', '3456789C', 'IE00BANK3456789012', 'alice.johnson@example.com', 'Galway', '986435789', '2023-01-01', 'Trainer', 3, 1),
       (DEFAULT, 'Bob', 'Williams', '4567890D', 'IE00BANK4567890123', 'bob.williams@example.com', 'Limerick', '198754356', '2023-01-01', 'Manager', 1, NULL);
...
VALUES (DEFAULT, 'Yoga 101', 'Beginner yoga class', '60 minutes', 10, 1, 1),
       ...
       (DEFAULT, 'Yoga 201', 'Intermediate yoga class', '60 minutes', 10, 2, 4);
...
VALUES (DEFAULT, 'Irish Fitness Equipment', '123 Main St, Dublin, Ireland', '728940386', 'info@irishfitnessequipment.ie'),
       (DEFAULT, 'Bodhi Fitness Equipment', '456 Elm St, Cork, Ireland', '278393846', 'info@bodhifitnessequipment.ie'),
       (DEFAULT, 'Chakra Fitness Equipment', '789 Pine St, Galway, Ireland', '927874682', 'info@chakrafinessequipment.ie'),
       (DEFAULT, 'Dharma Fitness Equipment', '101112 Oak St, Limerick, Ireland', '928457289', 'info@dharmafitnessequipment.ie');
